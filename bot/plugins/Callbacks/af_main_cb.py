...
async def cb_navg(bot, update: CallbackQuery):
    ...
    text=f"<i>pls Join our channels Found</i> <code>{leng}</code> <i>Results For Your Request 🤗:</i> <code>{query}</code>"
...
async def callback_data(bot, update: CallbackQuery):
    ...
    if query_data == "start":
        buttons = [[
            InlineKeyboardButton('My Dev 🔥', url='https://t.me/M_r_Einstein'),
            InlineKeyboardButton('⭕️ our channel ⭕️', url ='https://t.me/Cinemaabranthanmar_Channel')
        ],[
            InlineKeyboardButton('💞 Support us 🔥', url='https://t.me/Cinemaabranthanmar_Group')
        ],[
